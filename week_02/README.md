...
1. Download and print the [Python cheat sheet](https://perso.limsi.fr/pointal/python:memento).
...
1. Prelecture videos:
    ...
    1. [Lesson 5](https://www.youtube.com/watch?v=buMTH6ICnqk&list=PL0-84-yl1fUnRuXGFe_F7qSH1LEnn9LkW&index=5)
        ...
        What is the truthy/falsey values for `int`, `str`, and `float`?
...
The lab assignment is worth 10 points.
