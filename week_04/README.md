...
1. We will cover [Chapter 6 - Strings](https://automatetheboringstuff.com/2e/chapter6/) and [Chapter 7 - Regular Expressions](https://automatetheboringstuff.com/2e/chapter7/) of the book.
   ...
   You will never be required to use regular expressions in this class, however.
