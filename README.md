...
| 6  | Tues, 8 Oct   | Python: Strings ([Sweigart](https://automatetheboringstuff.com/), Chapter 6)<br/>[The requests library](https://realpython.com/python-requests/) | Lab 7<br/>[Quiz: strings](https://realpython.com/quizzes/python-strings/)<br/>In-class quiz: lists |
| 6  | Thur, 10 Oct  | Python: Regular Expressions ([Sweigart](https://automatetheboringstuff.com/), Chapter 7) | Lab 8<br/>[Quiz: sets](https://realpython.com/quizzes/python-sets/)<br/>HW 2 |
