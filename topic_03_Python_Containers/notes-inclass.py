...
$ python3 -m doctest topic03/notes.py

Without --verbose only failing test cases get printed.
Test cases that pass print nothing.
...
def filter_odd(xs):
    ...
    The right way to "remove" items from a list;
    is to create a new empty list and add elements you don't want removed
    to the empty list.
